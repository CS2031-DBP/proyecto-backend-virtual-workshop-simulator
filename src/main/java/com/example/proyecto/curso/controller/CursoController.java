...
public class CursoController {
    ...
    public ResponseEntity<List<CursoResponseDto>> obtenerCursosPorCarrera(@PathVariable Long carreraId) {
        List<CursoResponseDto> cursos = cursoService.obtenerCursosPorCarrera(carreraId);
